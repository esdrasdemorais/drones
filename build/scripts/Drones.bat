...
set CLASSPATH=%APP_HOME%\lib\gs-gradle-0.1.7.jar;%APP_HOME%\lib\joda-time-2.2.jar;%APP_HOME%\lib\Ddd-master-SNAPSHOT.jar;%APP_HOME%\lib\commons-math3-3.6.1.jar;%APP_HOME%\lib\mongodb-driver-3.8.2.jar;%APP_HOME%\lib\guava-23.0.jar;%APP_HOME%\lib\gson-2.8.5.jar;%APP_HOME%\lib\mongodb-driver-core-3.8.2.jar;%APP_HOME%\lib\bson-3.8.2.jar;%APP_HOME%\lib\jsr305-1.3.9.jar;%APP_HOME%\lib\error_prone_annotations-2.0.18.jar;%APP_HOME%\lib\j2objc-annotations-1.1.jar;%APP_HOME%\lib\animal-sniffer-annotations-1.14.jar
